# Soviet Union — In Good Faith — platform catalog
...
Krasny Okean — Heavy industrial investment funds a Soviet battle fleet, carriers and the escorts needed to operate them across separated seas.
...
| Parizhskaya Kommuna | sevastopol_1914 | 1 | warship | active |
| Oktyabrskaya Revolyutsiya | sevastopol_1914 | 1 | warship | active |
| Krasny Krym | svetlana_1913 | 1 | warship | active |
| Sovetskaya Respublika battleship | ocean_bb28 | 1 | warship | active |
| Sovetskaya Respublika battleship | ocean_bb28 | 1 | warship | active |
| Krasny Okean carrier | ocean_cv30 | 1 | warship | active |
| Krasny Okean carrier | ocean_cv30 | 1 | warship | active |
| Kirov ocean cruiser | ocean_cl29 | 3 | warship | active |
| Kirov ocean cruiser | ocean_cl29 | 3 | warship | active |
| Shtorm escort destroyer | ocean_dd30 | 18 | warship | active |
| Shtorm escort destroyer | ocean_dd30 | 18 | warship | active |
| Okean patrol submarine | ocean_ss29 | 12 | warship | active |
| Okean patrol submarine | ocean_ss29 | 12 | warship | active |
| Sovetsky Soyuz battleship | ocean_bb34 | 2 | warship | building |
| Novik type destroyer | novik_series | 17 | warship | active |
| Bars class submarine | bars_1915 | 6 | warship | reserve |
| Krasny Okean fleet oiler | sov_program_oiler | 6 | support | active |

Other merchant register: 575 hulls. Total merchant register: 575 hulls / 1,110,811 GRT.
...
| AA barrels | 8 |
| Belt / deck (mm) | 100 / 25 |
| Embarked aircraft | 80 |
| Complement | 1210 |
| Hull price (gold) | 14400 |
| Registered merchant capacity (GRT) | Not applicable / opening register allocation |
| Opening construction catalog | Listed; year, treaty and obsolescence rules apply |
| Fit notes | Alternate-history program, authored for In Good Faith. Provisional engineering and procurement estimates. |
