# France — The Treaty System — equipment and aircraft catalog
...
|---|---:|---|---:|---:|
| Brest | 60 | 15 Nieuport naval fighter (fighter); 7 FBA Type H (scout); 14 Farman maritime bomber (strike) | 36 | 720 |
| Toulon | 60 | 15 Nieuport naval fighter (fighter); 7 FBA Type H (scout); 14 Farman maritime bomber (strike) | 36 | 720 |
| Dakar | 30 | 8 Nieuport naval fighter (fighter); 4 FBA Type H (scout); 6 Farman maritime bomber (strike) | 18 | 360 |
...
### Nieuport naval fighter — `fra_early_fighter`
...
### Farman maritime bomber — `fra_early_strike`
...
### FRA 1930 fighter — `fra_standard_1930_fighter`
...
```json
{
  "id": "fra_standard_1930_fighter",
  "nation": "FRA",
  "name": "FRA 1930 fighter",
  "type_year": 1930,
  "role": "fighter",
  "crew": {
    "normal": 1
...
### FRA 1930 strike — `fra_standard_1930_strike`
...
```json
{
  "id": "fra_standard_1930_strike",
  "nation": "FRA",
  "name": "FRA 1930 strike",
  "type_year": 1930,
  "role": "strike",
  "crew": {
    "normal": 2
...
### FRA 1930 scout — `fra_standard_1930_scout`
...
### FRA 1936 fighter — `fra_standard_1936_fighter`
...
```json
{
  "id": "fra_standard_1936_fighter",
  "nation": "FRA",
  "name": "FRA 1936 fighter",
  "type_year": 1936,
  "role": "fighter",
  "crew": {
    "normal": 1
...
### FRA 1936 strike — `fra_standard_1936_strike`
...
```json
{
  "id": "fra_standard_1936_strike",
  "nation": "FRA",
  "name": "FRA 1936 strike",
  "type_year": 1936,
  "role": "strike",
  "crew": {
    "normal": 2
...
### FRA 1936 scout — `fra_standard_1936_scout`
...
### FRA 1942 fighter — `fra_standard_1942_fighter`
...
```json
{
  "id": "fra_standard_1942_fighter",
  "nation": "FRA",
  "name": "FRA 1942 fighter",
  "type_year": 1942,
  "role": "fighter",
  "crew": {
    "normal": 1
...
### FRA 1942 strike — `fra_standard_1942_strike`
...
```json
{
  "id": "fra_standard_1942_strike",
  "nation": "FRA",
  "name": "FRA 1942 strike",
  "type_year": 1942,
  "role": "strike",
  "crew": {
    "normal": 2
...
### FRA 1942 scout — `fra_standard_1942_scout`
