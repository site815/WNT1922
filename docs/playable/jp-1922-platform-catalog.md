# Japan — The Treaty System — platform catalog
...
The Treaty System — A historical Pacific fleet under the three-fifths limit. Canceled battleships make carrier conversions, training and superior individual ships the path forward.
...
|---|---|---:|---|---|
| Settsu | kawachi | 1 | warship | reserve |
...
| Kaga | tosa | 1 | warship | building |
| Tosa | tosa | 1 | warship | building |
| Amagi | amagi | 1 | warship | converting |
| Akagi | amagi | 1 | warship | converting |
| Atago | amagi | 1 | warship | building |
| Takao | amagi | 1 | warship | building |
| Hosho | hosho | 1 | warship | building |
| Kuma class | kuma | 5 | warship | active |
| Nagara class | nagara | 6 | warship | building |
| Minekaze class | minekaze | 13 | warship | active |
| Momi class (2nd class) | momi | 21 | warship | active |
| Kaichu type | kaichu | 20 | warship | active |

Other merchant register: 2,033 hulls. Total merchant register: 2,033 hulls / 3,354,806 GRT.
