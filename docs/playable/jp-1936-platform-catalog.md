...
### Standard Maru fleet tender — `maru_depot_t23`
...
| Registered merchant capacity (GRT) | Not applicable / opening register allocation |
| Opening construction catalog | Listed; year, treaty and obsolescence rules apply |
| Fit notes | Standard Maru oiler/depot hybrid. Admirals route fuel deliveries to fleets and use its workshops for local supply while stationed in a friendly port. Naval support, separate from merchant GRT. |
